...
if(isset($_POST['order_btn'])){
   ...
   $detail_query = mysqli_query($conn, "INSERT INTO `order`(name, number, email, method, house_no, city, street,state, total_products, total_price) VALUES('$name','$number','$email','$method','$house_no','$city','$street','$state','$total_product','$price_total')") or die('query failed');
...
<section class="checkout-form">
   ...
   <div class="display-order">
      ...
      ?>
      <span class="grand-total"> grand total : Rs.601,100 </span>
   </div>
      <div class="flex">
         <div class="inputBox">
            <span>your name</span>
